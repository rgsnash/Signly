  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide",
  {
    variants: {
      variant: {
        ...
        primary: "bg-pink-600 text-primary-foreground hover:bg-pink400/90 border-pink-700 border border-b-4 active:border-b-0",
        primaryOutline: "bg-white text-pink-600 hover:bg-slate-100",
        secondary: "bg-violet-600 text-primary-foreground hover:bg-sky400/90 border-violet-700 border border-b-4 active:border-b-0",
        secondaryOutline: "bg-white text-violet-600 hover:bg-slate-100",
        danger: "bg-rose-600 text-primary-foreground hover:bg-sky400/90 border-rose-700 border border-b-4 active:border-b-0",
        dangerOutline: "bg-white text-rose-600 hover:bg-slate-100",
        super: "bg-yellow-500 text-primary-foreground hover:bg-sky400/90 border-yellow-600 border border-b-4 active:border-b-0",
        superOutline: "bg-white text-yellow-600 hover:bg-slate-100",
